...
const Hero = () => {
  ...
  return <section id="home" className="relative bg-hero-blue overflow-hidden pt-16">
      ...
      <div className="container relative z-10 md:py-24 border-primary rounded-3xl bg-primary border-none border-0 py-[15px] px-[15px] mx-0 my-0 ml-0 mr-0 mb-0 mt-0">
