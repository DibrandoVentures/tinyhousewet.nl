...
const Hero = () => {
  ...
  return <section id="home" className="relative bg-hero-blue overflow-hidden pt-16">
      ...
      <div className="container relative z-10 md:py-24 border-primary border rounded-3xl px-0 py-0 mx-0 bg-primary border-dotted">
        <div className="grid md:grid-cols-2 gap-12 items-center bg-primary">
          <div className="text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight mx-[5px]">Tiny house en de wet: hoe zit het nou echt?</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" variant="secondary" onClick={() => scrollToSection("tiny-house-wet")} className="text-hero-blue shadow-lg bg-accent">
                Lees meer
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>

            <div className="space-y-2 bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-2xl">
